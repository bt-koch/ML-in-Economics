...
recursively trained models by year, using a threshold determined by the maximized
weighted average using factor 1.5 (note that the AUROC is not dependent on the
threshold chosen [@jarmulska2020]).

*hier noch performance kommentieren/einordnen/vergleichen*
