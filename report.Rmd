...
\textcolor{red}{*hier noch gewählte Parameter für Random Forest beschreiben*}
...
curves is recognisable. When examining these plots for the independent variables
used in this model, for many variables a U-shaped curve can be detected, indicating
that both up- and downshifts in the corresponding variable contribute to higher
probability of fiscal stress. However, these U-shaped curves are strongly influenced
...
with caution [@jarmulska2020].

\textcolor{red}{*hier ein plot ersetzen mit u-shaped da interessanter, zB unemployment*}
